...
public class SenderService {
    static void sendMail(String filename, String email, String numeClient) {
        ...
        try {
            ...
            message.setSubject("Factura Client "+numeClient);
...
/*    static void sendRaportMail(String filename, String email) {
        final String username = "andreea.barcan@s.unibuc.ro";
        final String password = "Adv#2697";
        ...
        try {
            ...
            // Set Subject: header field
            message.setSubject("Raport al profitului");
